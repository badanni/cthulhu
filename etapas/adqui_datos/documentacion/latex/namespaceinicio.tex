...
Definición en la línea 143 del archivo inicio.py.


\begin{DoxyCode}
144           :
145         if os.name=="posix": #verifica que sea un entorno Linux
146                 app = prueba_adqui() #instancia el objeto GUI con las senales enl
      azadas
147                 gtk.main() #levanta el motor GTK para poder visualizar
