...
Se debe especificar cual es el IP del servidor \begin{DoxyAuthor}{Autores}
Danny Vasconez 
...
\end{DoxyPrecond}
\begin{Desc}
\item[\hyperlink{bug__bug000002}{Bug}]myTemperature tiene falla por el tipo de dato en formato a python '' toca pasar a '0x81' \end{Desc}
\begin{DoxyWarning}{Atención}
uso inapropiado puede hacer que la aplicacion falle
\end{DoxyWarning}
\hypertarget{index_intro}{}\subsection{Ejemplo de uso}\label{index_intro}
